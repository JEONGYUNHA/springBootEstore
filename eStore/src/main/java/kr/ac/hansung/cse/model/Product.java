...
public class Product implements Serializable  {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY) // AUTO -> default -> TABLE(hibernate_sequence table 생성)
	@Column(name="product_id", nullable = false, updatable = false) // name 뿐만 아니라 다양한 속성들도 넣을 수 있다.
	private int id;
	...
	@Transient // database에 저장될 때는 빠진다.
